...
public class AllCustomersWithLargeInvoices2 extends DBObject {
  public static final int _ITEMS = 0;
  private long id;
  private List<Customer> items = ListExt.List();
  private List<TypeAndId> itemsRef;

  public AllCustomersWithLargeInvoices2() {}

  public AllCustomersWithLargeInvoices2(List<Customer> items) {
    this.items = items;
  }
  ...
  @Override
  public int _typeIdx() {
    return SchemaConstants.AllCustomersWithLargeInvoices2;
  }

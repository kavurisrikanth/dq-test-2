...
public class GqlToSql {
	...
	private void addReferenceCollectionField(SqlAstNode node, Field field, DField<?, ?> df, DModel<?> nonEmbeddedModel) {
	...
	private void addReferenceField(SqlAstNode node, List<Selection> selections, DModel<?> parentType, DModel<?> nonEmbeddedModel) {
